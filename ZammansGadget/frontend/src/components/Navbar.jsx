...
//       <Link
//         to='/'
//         className='pl-4 text-xl font-extrabold text-transparent sm:text-2xl md:text-3xl lg:text-4xl sm:text-3xl bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 bg-clip-text sm:pl-6 md:pl-8 lg:pl-4 whitespace-nowrap'>
//         Z<span className="text-black">amman&apos;s</span> <span className="text-blue-600">Gadget</span>
//       </Link>
...
//       <Link
//         to='/'
//         className='pl-4 text-xl font-extrabold text-transparent sm:text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 bg-clip-text sm:pl-6 md:pl-8 lg:pl-4 whitespace-nowrap'>
//         Z<span className="text-black">amman&apos;s</span> <span className="text-blue-600">Gadget</span>
//       </Link>
...
//         className='pl-4 font-extrabold text-transparent bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 bg-clip-text whitespace-nowrap'
//         style={{
//           fontSize: 'clamp(14px, 4vw, 34px)',  // Fully responsive font size
//           lineHeight: '1',
//           maxWidth: '90vw',                   // Jeno overly boro hoy na
//           overflow: 'hidden',
